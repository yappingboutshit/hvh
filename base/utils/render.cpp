...
void Render::CreateFonts( ) {
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::ManualIndicator = Interfaces::Surface->FontCreate(), _("Arial Bold"), 26, FW_BOLD, NULL, NULL, FONTFLAG_DROPSHADOW | FONTFLAG_ANTIALIAS);
